...
build-gem-linux-amd64: build-binary-linux-amd64
	mkdir -p $(GEM_DIR)/exe
...
build-gem-linux-arm64: build-binary-linux-arm64
	mkdir -p $(GEM_DIR)/exe
...
build-gem-darwin-amd64: build-binary-darwin-amd64
	mkdir -p $(GEM_DIR)/exe
...
build-gem-darwin-arm64: build-binary-darwin-arm64
	mkdir -p $(GEM_DIR)/exe
