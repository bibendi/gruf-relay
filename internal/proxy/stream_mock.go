...
//
//	mockgen -destination=stream_mock.go -package proxy google.golang.org/grpc ServerStream
//
...
func (mr *MockServerStreamMockRecorder) RecvMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServerStreamMockRecorder) SendMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
